  ...
  return (
    <div className="min-h-screen bg-[#313338] flex items-center justify-center p-4 font-sans">
      <motion.div 
        ...
        className="w-full max-w-[480px] bg-[#2B2D31] rounded-[8px] shadow-[0_8px_16px_rgba(0,0,0,0.3)] overflow-hidden"
      >
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="bg-[#F0B232]/10 border border-[#F0B232]/20 rounded-[4px] p-3 flex gap-3">
            ...
            <div>
              <p className="text-[#F0B232] text-[13px] font-bold">Administrator Permission Required</p>
          ...
          {/* Why Admin Permission - Discord Style Info Box */}
          <div className="bg-[#4E5058]/10 border border-[#4E5058]/20 rounded-[4px] p-3 flex gap-3">
            ...
            <div>
              <p className="text-[#F2F3F5] text-[13px] font-bold">Why this permission?</p>
