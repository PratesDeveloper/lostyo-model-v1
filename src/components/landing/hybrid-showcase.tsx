    ...
    <section id="features" className="py-24 border-t border-white/5">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-4xl font-bold mb-6">The Power of <span className="text-[#5865F2]">Hybridization</span></h2>
          ...
          <div className="relative">
            <div className="aspect-square rounded-3xl bg-gradient-to-br from-[#5865F2] to-indigo-900 opacity-20 blur-3xl absolute inset-0 -z-10" />
            <div className="bg-[#1E1F22] border border-white/10 rounded-2xl p-4 shadow-2xl">
               <div className="flex items-center gap-2 mb-4 px-2">
                 <div className="w-3 h-3 rounded-full bg-red-500" />
                 <div className="w-3 h-3 rounded-full bg-yellow-500" />
                 <div className="w-3 h-3 rounded-full bg-green-500" />
                 <div className="ml-2 px-2 py-0.5 rounded bg-white/5 text-[10px] text-gray-500 uppercase tracking-widest">Aether Hybrid Interface</div>
               </div>
               <div className="space-y-4">
                 <div className="h-4 w-3/4 bg-white/5 rounded" />
                 <div className="h-4 w-1/2 bg-white/5 rounded" />
                 <div className="grid grid-cols-3 gap-4 py-4">
                    <div className="aspect-square bg-[#5865F2]/20 rounded-xl flex items-center justify-center border border-[#5865F2]/30">
                      <Terminal className="text-[#5865F2]" />
                    </div>
